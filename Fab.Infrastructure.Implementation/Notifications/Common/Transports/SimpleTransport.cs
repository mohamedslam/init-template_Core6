...
public abstract class SimpleTransport : INotificationTransport
{
    ...
    public abstract Task SendAsync(Notification notification, Communication communication,
                                   CancellationToken cancellationToken = default);

    public Task SendBatchAsync(Notification notification, IReadOnlyCollection<Communication> communications,
                               CancellationToken cancellationToken = default) =>
        Task.WhenAll(communications.Select(communication => SendAsync(notification, communication, cancellationToken)));
}